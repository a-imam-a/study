...
public class KafkaConfiguration {
    ...
    @Bean
    public ConsumerFactory<String, OrderStatusEvent> kafkaOrderEventConsumerFactory(ObjectMapper objectMapper) {
        Map<String, Object> config = new HashMap<>();
    ...
    public ConcurrentKafkaListenerContainerFactory<String, OrderStatusEvent> kafkaOrderStatusEventConcurrentKafkaListenerContainerFactory(
            ConsumerFactory<String, OrderStatusEvent> kafkaOrderEventConsumerFactory
    ) {
