package com.example.orderservice.configaration;
...
public class KafkaConfiguration {
    ...
    @Bean
    public ProducerFactory<String, OrderStatusEvent> kafkaOrderEventProducerFactory(ObjectMapper objectMapper) {
    ...
    @Bean
    public KafkaTemplate<String, OrderStatusEvent> kafkaTemplate(ProducerFactory<String, OrderStatusEvent> kafkaOrderEventProducerFactory) {
